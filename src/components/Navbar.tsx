...
export default function Navbar({ logoUrl }: NavbarProps) {
  ...
  useEffect(() => {
    const onScroll = () => setScrolled(window.scrollY > 128)
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-20 lg:h-32">
          {/* Logo */}
            ...
            {logoUrl ? (
              <Image
                ...
                style={{
                  filter: solid
                    ? undefined
                    : 'drop-shadow(0 0 12px rgba(255,255,255,0.10)) drop-shadow(0 1px 6px rgba(0,0,0,0.35))',
